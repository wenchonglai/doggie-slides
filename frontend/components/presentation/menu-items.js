...
const PRESENT = { name: "Present", icon: undefined, shortCut: undefined, actionName: 'present'};
...
export const SLIDE_TOOLBAR_ITEMS = [
  ...BASE_TOOLBAR_ITEMS, undefined, BACKGROUND
];
